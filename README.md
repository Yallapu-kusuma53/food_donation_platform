...
<h2>How to Run the Project (XAMPP)</h2>
<ol>
    <li>Download the project ZIP file.</li>
    <li>Extract the file and copy the folder.</li>
    <li>Paste inside the root directory: <strong>`xampp/htdocs`</strong></li>
    <li>Open PHPMyAdmin (`http://localhost/phpmyadmin`).</li>
    <li>Create a new database.</li>
    <li>Import the `demo.sql` file (found inside the database folder).</li>
