...
// XAMPP default port for MySQL is usually 3306
$host = "localhost"; // or use "127.0.0.1" if "localhost" fails
$user = "root";
$pass = "";
$dbname = "demo"; // Make sure this DB exists in phpMyAdmin
...
<script>
      <?php
            ...
            $female=$ro2['count'];
            $male=$row['count'];
            $q3="SELECT count(*) as count FROM food_donations where location=\"ysr_kadapa\"";
            $res3=mysqli_query($connection, $q3);
            $ro3=mysqli_fetch_assoc($res3);
            $madurai=$ro3['count'];
            $q4="SELECT count(*) as count FROM food_donations where location=\"visakhapatnam\"";
            $res4=mysqli_query($connection, $q4);
            $ro4=mysqli_fetch_assoc($res4);
            $chennai=$ro4['count'];
            $q5="SELECT count(*) as count FROM food_donations where location=\"vizianagaram\"";
...
var xplace=["ysr_kadapa","visakhapatnam","vizianagaram"];
