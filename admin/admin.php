...
// Now use $connection instead of creating a new one again
?>
...
<head>
    ...
    <!----===== Iconscout CSS ===== -->
   <!-- Use latest version or try an older one -->
...
<?php
$connection = mysqli_connect("localhost", "root", "", "demo"); // ✅ no port
...
$sql = "SELECT * FROM food_donations WHERE location=\"$loc\"";
